...
folder = 'E:\workspace\github\create-car-license-plate\license2'
save_folder = 'E:\workspace\github\plate_dataset\plate_process_image'
with open('file_label.txt', 'w') as file:
